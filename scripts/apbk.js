...
*/
  ...
  app.updateForecastCard = function(data) {
    ...
    //console.log(app.visibleCards[data.key]);
    //console.log(data.response[0].terbaru.length);
    card.querySelector('.description').textContent = data.response[0].terbaru[0].title;
  ...
  app.getForecast = function(key, label) {
    ...
    url += key + '.json';*/
    //var url = 'http://api.viva.co.id/v/212/terbarulist';
